...
namespace ADMentor.DataAccess
{
    public class AdRepository : ModelEntityRepository
    {
        ...
        public override Option<ModelEntity.Element> Instanciate(ModelEntity.Element classifier, ModelEntity.Package package, IEnumerable<EAAddInBase.MDGBuilder.ElementStereotype> stereotypes)
        {
